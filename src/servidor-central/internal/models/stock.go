...
const (
	...
	TipoAjusteStock          TipoMovimiento = "ajuste"
...
func (dto *MovimientoStockCreateDTO) ToModel(usuarioID uuid.UUID) *MovimientoStock {
	return &MovimientoStock{
		...
		ProcesoOrigen:       func() *PrioridadProceso { p := PrioridadMaxima; return &p }(), // Por defecto, movimientos manuales son de máxima prioridad
	}
}
...
func (m *MovimientoStock) Validate() error {
	...
	validTipos := []TipoMovimiento{
		TipoEntrada, TipoSalida, TipoAjusteStock, TipoTransferenciaEntrada,
