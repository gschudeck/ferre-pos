...
type ParametrosReporteConfig struct {
...
// ParametrosReporte es un tipo para manejar arrays de ParametroReporte
type ParametrosReporte []ParametroReporte
...
// RolesUsuario es un tipo para manejar arrays de RolUsuario
type RolesUsuario []RolUsuario

func (r RolesUsuario) Value() (driver.Value, error) {
	return json.Marshal(r)
}

func (r *RolesUsuario) Scan(value interface{}) error {
	if value == nil {
		return nil
	}
	bytes, ok := value.([]byte)
...
// WidgetsDashboard es un tipo para manejar arrays de WidgetDashboard
type WidgetsDashboard []WidgetDashboard

func (w WidgetsDashboard) Value() (driver.Value, error) {
	return json.Marshal(w)
}

func (w *WidgetsDashboard) Scan(value interface{}) error {
	if value == nil {
		return nil
	}
	bytes, ok := value.([]byte)
